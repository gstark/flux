 ...
 * Returns the core instructions without dynamic context injection.
...
export function getDefaultPromptTemplates(): {
  ...
  // For work: return the core instructions (tenets, commit guidance, etc.)
  // without the specific issue details
  const work = `You are a Flux autonomous agent. You have been assigned an issue to implement.
...
You just finished working on this issue. Your summary: "{{WORK_NOTE}}"
